...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_adaccount', (
        ...
        db.send_create_signal('main', ['AdAccount'])

        # Adding model 'AdAccountOwner'
        db.create_table('main_adaccountowner', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.AdAccountOwner'], null=True, blank=True)),
            ('InternalId', self.gf('django.db.models.fields.CharField')(max_length=80, blank=True)),
        ))
        db.send_create_signal('main', ['AdAccountOwner'])


    def backwards(self, orm):
        # Deleting model 'AdAccount'
        db.delete_table('main_adaccount')

        # Deleting model 'AdAccountOwner'
        db.delete_table('main_adaccountowner')
