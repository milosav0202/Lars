...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LarsClient.BudgetCurrency'
        db.add_column('main_larsclient', 'BudgetCurrency',
                      self.gf('django.db.models.fields.CharField')(default='USD', max_length=5),
                      keep_default=False)

        # Adding field 'LarsClient.Budget'
        db.add_column('main_larsclient', 'Budget',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)

        # Deleting field 'Account.BudgetCurrency'
        db.delete_column('main_account', 'BudgetCurrency')

        # Deleting field 'Account.Budget'
        db.delete_column('main_account', 'Budget')


    def backwards(self, orm):
        # Deleting field 'LarsClient.BudgetCurrency'
        db.delete_column('main_larsclient', 'BudgetCurrency')

        # Deleting field 'LarsClient.Budget'
        db.delete_column('main_larsclient', 'Budget')

        # Adding field 'Account.BudgetCurrency'
        db.add_column('main_account', 'BudgetCurrency',
                      self.gf('django.db.models.fields.CharField')(default='USD', max_length=5),
                      keep_default=False)

        # Adding field 'Account.Budget'
        db.add_column('main_account', 'Budget',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)
