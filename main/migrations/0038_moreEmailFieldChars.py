...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AGEmailLog.phone'
        db.alter_column(u'main_agemaillog', 'phone', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'AGEmailLog.phone'
        db.alter_column(u'main_agemaillog', 'phone', self.gf('django.db.models.fields.CharField')(max_length=30))
