...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GoogleAccountPerformanceReport.AccountTimeZoneId'
        db.alter_column('main_googleaccountperformancereport', 'AccountTimeZoneId', self.gf('django.db.models.fields.CharField')(max_length=60))

    def backwards(self, orm):

        # Changing field 'GoogleAccountPerformanceReport.AccountTimeZoneId'
        db.alter_column('main_googleaccountperformancereport', 'AccountTimeZoneId', self.gf('django.db.models.fields.IntegerField')())
