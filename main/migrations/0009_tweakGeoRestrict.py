...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'GoogleGeoPerformanceReport', fields ['MetroCriteriaId', 'AdGroupId', 'CountryCriteriaId', 'CityCriteriaId', 'Date', 'ExternalCustomerId', 'RegionCriteriaId']
        db.delete_unique('main_googlegeoperformancereport', ['MetroCriteriaId', 'AdGroupId', 'CountryCriteriaId', 'CityCriteriaId', 'Date', 'ExternalCustomerId', 'RegionCriteriaId'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'GoogleGeoPerformanceReport', fields ['MetroCriteriaId', 'AdGroupId', 'CountryCriteriaId', 'CityCriteriaId', 'Date', 'ExternalCustomerId', 'RegionCriteriaId']
        db.create_unique('main_googlegeoperformancereport', ['MetroCriteriaId', 'AdGroupId', 'CountryCriteriaId', 'CityCriteriaId', 'Date', 'ExternalCustomerId', 'RegionCriteriaId'])
