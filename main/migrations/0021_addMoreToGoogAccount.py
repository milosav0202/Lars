...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GoogleAccountPerformanceReport.Conversions'
        db.add_column('main_googleaccountperformancereport', 'Conversions',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'GoogleAccountPerformanceReport.CostPerConversion'
        db.add_column('main_googleaccountperformancereport', 'CostPerConversion',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'GoogleAccountPerformanceReport.ConversionRate'
        db.add_column('main_googleaccountperformancereport', 'ConversionRate',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'GoogleAccountPerformanceReport.TotalConvValue'
        db.add_column('main_googleaccountperformancereport', 'TotalConvValue',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'GoogleAccountPerformanceReport.ViewThroughConversions'
        db.add_column('main_googleaccountperformancereport', 'ViewThroughConversions',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'GoogleAccountPerformanceReport.ValuePerConversion'
        db.add_column('main_googleaccountperformancereport', 'ValuePerConversion',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GoogleAccountPerformanceReport.Conversions'
        db.delete_column('main_googleaccountperformancereport', 'Conversions')

        # Deleting field 'GoogleAccountPerformanceReport.CostPerConversion'
        db.delete_column('main_googleaccountperformancereport', 'CostPerConversion')

        # Deleting field 'GoogleAccountPerformanceReport.ConversionRate'
        db.delete_column('main_googleaccountperformancereport', 'ConversionRate')

        # Deleting field 'GoogleAccountPerformanceReport.TotalConvValue'
        db.delete_column('main_googleaccountperformancereport', 'TotalConvValue')

        # Deleting field 'GoogleAccountPerformanceReport.ViewThroughConversions'
        db.delete_column('main_googleaccountperformancereport', 'ViewThroughConversions')

        # Deleting field 'GoogleAccountPerformanceReport.ValuePerConversion'
        db.delete_column('main_googleaccountperformancereport', 'ValuePerConversion')
    ...
    models = {
        'main.account': {
            ...
            'Meta': {'unique_together': "(('ServiceType', 'ServiceAccountId'),)", 'object_name': 'Account'},
