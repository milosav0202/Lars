...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdAccountOwnership'
        db.create_table('main_adaccountownership', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('AdAccountOwner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.AdAccountOwner'])),
            ('AdAccount', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.AdAccount'], unique=True)),
        ))
        db.send_create_signal('main', ['AdAccountOwnership'])

        # Adding model 'AdAccountGrouping'
        db.create_table('main_adaccountgrouping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parentaccount', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.AdAccountOwner'])),
            ('subaccount', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.AdAccount'], unique=True)),
        ))
        db.send_create_signal('main', ['AdAccountGrouping'])

        # Adding unique constraint on 'AdAccount', fields ['ServiceAccountId', 'ServiceType']
        db.create_unique('main_adaccount', ['ServiceAccountId', 'ServiceType'])


    def backwards(self, orm):
        # Removing unique constraint on 'AdAccount', fields ['ServiceAccountId', 'ServiceType']
        db.delete_unique('main_adaccount', ['ServiceAccountId', 'ServiceType'])

        # Deleting model 'AdAccountOwnership'
        db.delete_table('main_adaccountownership')

        # Deleting model 'AdAccountGrouping'
        db.delete_table('main_adaccountgrouping')
    ...
    models = {
        ...
        'main.adaccount': {
            'Active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'AdAccountOwner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.AdAccountOwner']"}),
        ...
        'main.adaccountgrouping': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parentaccount': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.AdAccountOwner']"}),
            'subaccount': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.AdAccount']", 'unique': 'True'})
        },
        'main.adaccountowner': {
            ...
            'Name': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.AdAccountOwner']", 'null': 'True', 'blank': 'True'})
        },
        'main.adaccountownership': {
            'AdAccount': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.AdAccount']", 'unique': 'True'}),
            'AdAccountOwner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.AdAccountOwner']"}),
