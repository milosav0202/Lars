...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MasterAccount.GoogleMCCId'
        db.alter_column(u'main_masteraccount', 'GoogleMCCId', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

    def backwards(self, orm):

        # Changing field 'MasterAccount.GoogleMCCId'
        db.alter_column(u'main_masteraccount', 'GoogleMCCId', self.gf('django.db.models.fields.CharField')(default='', max_length=80))
    ...
    models = {
        ...
        u'main.masteraccount': {
            'GoogleMCCId': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True', 'blank': 'True'}),
        ...
        u'main.voicestarcalllog': {
            ...
            'dna_class': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
