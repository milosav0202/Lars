...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Account', fields ['ServiceType', 'Name']
        db.delete_unique('main_account', ['ServiceType', 'Name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Account', fields ['ServiceType', 'Name']
        db.create_unique('main_account', ['ServiceType', 'Name'])
