...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VoiceStarCallLog.dna_class'
        db.add_column(u'main_voicestarcalllog', 'dna_class',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VoiceStarCallLog.dna_class'
        db.delete_column(u'main_voicestarcalllog', 'dna_class')
