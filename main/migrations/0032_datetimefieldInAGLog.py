...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AGEmailLog.ServerDateTime'
        db.add_column('main_agemaillog', 'ServerDateTime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 22, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AGEmailLog.ServerDateTime'
        db.delete_column('main_agemaillog', 'ServerDateTime')
