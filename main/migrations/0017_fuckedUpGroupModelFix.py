...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MasterAccount'
        db.create_table('main_masteraccount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('Name', self.gf('django.db.models.fields.CharField')(max_length=120)),
        ))
        db.send_create_signal('main', ['MasterAccount'])
        ...
        # Deleting field 'Account.Shared'
        db.delete_column('main_account', 'Shared')


    def backwards(self, orm):
        # Deleting model 'MasterAccount'
        db.delete_table('main_masteraccount')

        # Deleting model 'Group'
        db.delete_table('main_group')

        # Adding field 'Account.Shared'
        db.add_column('main_account', 'Shared',
