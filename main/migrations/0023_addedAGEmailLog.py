...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AGEmailLog'
        db.create_table('main_agemaillog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('Rid', self.gf('django.db.models.fields.CharField')(max_length=60, blank=True)),
            ('StoreNum', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('firstname', self.gf('django.db.models.fields.CharField')(max_length=60, blank=True)),
            ('lastname', self.gf('django.db.models.fields.CharField')(max_length=60, blank=True)),
            ...
            ('zipcode', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ...
            ('response', self.gf('django.db.models.fields.CharField')(max_length=60, blank=True)),
            ('projectname', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
            ('projectduedate', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
            ('projectdetails', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('offer', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('submit', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('ServerTime', self.gf('django.db.models.fields.DateField')()),
            ('misc1', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('misc2', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('misc3', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('misc4', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('misc5', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal('main', ['AGEmailLog'])


    def backwards(self, orm):
        # Deleting model 'AGEmailLog'
        db.delete_table('main_agemaillog')
