...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AdAccountGrouping.subaccount'
        db.alter_column('main_adaccountgrouping', 'subaccount_id', self.gf('django.db.models.fields.related.ForeignKey')(unique=True, to=orm['main.AdAccountOwner']))

    def backwards(self, orm):

        # Changing field 'AdAccountGrouping.subaccount'
        db.alter_column('main_adaccountgrouping', 'subaccount_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.AdAccount'], unique=True))
