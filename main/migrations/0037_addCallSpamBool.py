...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VoiceStarCallLog.is_spam'
        db.add_column(u'main_voicestarcalllog', 'is_spam',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VoiceStarCallLog.is_spam'
        db.delete_column(u'main_voicestarcalllog', 'is_spam')
