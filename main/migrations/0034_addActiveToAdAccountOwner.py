...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdAccountOwner.Active'
        db.add_column('main_adaccountowner', 'Active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdAccountOwner.Active'
        db.delete_column('main_adaccountowner', 'Active')
