...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AGEmailLog.misc5'
        db.alter_column('main_agemaillog', 'misc5', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'AGEmailLog.misc1'
        db.alter_column('main_agemaillog', 'misc1', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'AGEmailLog.misc3'
        db.alter_column('main_agemaillog', 'misc3', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'AGEmailLog.misc2'
        db.alter_column('main_agemaillog', 'misc2', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'AGEmailLog.misc4'
        db.alter_column('main_agemaillog', 'misc4', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'AGEmailLog.misc5'
        db.alter_column('main_agemaillog', 'misc5', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'AGEmailLog.misc1'
        db.alter_column('main_agemaillog', 'misc1', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'AGEmailLog.misc3'
        db.alter_column('main_agemaillog', 'misc3', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'AGEmailLog.misc2'
        db.alter_column('main_agemaillog', 'misc2', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'AGEmailLog.misc4'
        db.alter_column('main_agemaillog', 'misc4', self.gf('django.db.models.fields.CharField')(max_length=100))
