...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MasterAccount.GoogleMCCId'
        db.add_column(u'main_masteraccount', 'GoogleMCCId',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MasterAccount.GoogleMCCId'
        db.delete_column(u'main_masteraccount', 'GoogleMCCId')
    ...
    models = {
        ...
        u'main.masteraccount': {
            'GoogleMCCId': ('django.db.models.fields.CharField', [], {'max_length': '80', 'blank': 'True'}),
