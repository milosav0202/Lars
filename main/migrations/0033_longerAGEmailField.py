...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AGEmailLog.Rid'
        db.alter_column('main_agemaillog', 'Rid', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'AGEmailLog.Rid'
        db.alter_column('main_agemaillog', 'Rid', self.gf('django.db.models.fields.CharField')(max_length=60))
